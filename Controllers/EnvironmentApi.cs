...
{ 
    ...
    { 
        ...
        [HttpGet]
        [Route("/EDUARDOBANOSROMERO/Test/1.0.0/temperature/forecast/{days}")]
        [ValidateModelState]
        [SwaggerOperation("GetForecast")]
        [SwaggerResponse(statusCode: 200, type: typeof(ForecastResponse), description: "the forecast")]
        [SwaggerResponse(statusCode: 404, description: "forecast not found")]
        ...
        [HttpGet]
        [Route("/EDUARDOBANOSROMERO/Test/1.0.0/temperature/{zoneId}/heater")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/EDUARDOBANOSROMERO/Test/1.0.0/temperature/{zoneId}")]
        [ValidateModelState]
        ...
        [HttpPost]
        [Route("/EDUARDOBANOSROMERO/Test/1.0.0/temperature/{zoneId}/heater/{state}")]
        [ValidateModelState]
        [SwaggerOperation("SetHeaterState")]
        [SwaggerResponse(statusCode: 200, type: typeof(ModelApiResponse), description: "Status of the operation")]
        ...
        [HttpGet]
        [Route("/EDUARDOBANOSROMERO/Test/1.0.0/temperature")]
        [ValidateModelState]
